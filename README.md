...
Solucion de software orientada a resolver el reporte, almacenamiento y devolucion eficiente de pertenencias dentro de un campus institucional. El sistema centraliza los reportes de objetos hallados, facilitando a los usuarios la busqueda y reclamo de su s pertenencias mediante una arquitecturaa escalable.
